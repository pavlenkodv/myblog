    ...
    <!-- Default box -->
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Creating post</h3>
        ...
        <div class="box-body">
          <div class="col-md-6">
            ...
            <div class="form-group">
              <label for="exampleInputFile">Post's image</label>
              <input type="file" id="exampleInputFile" name="image">

              <p class="help-block">Any notification about the formats ..</p>
            </div>
            <div class="form-group">
          ...
          <div class="col-md-12">
            <div class="form-group">
              ...
              <textarea name="content" id="" cols="30" rows="10" class="form-control" >{{old('description')}}</textarea>
            </div>
          </div>
        </div>
        <!-- /.box-body -->
